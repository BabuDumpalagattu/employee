...
// Connect to MongoDB
mongoose.connect('mongodb+srv://babudumpalagattudg:Babu1234@cluster0.nvgln.mongodb.net/EMPLOYEEDATA', { useNewUrlParser: true, useUnifiedTopology: true })
...
// Serve the HTML form
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'storing','index.html'));
   // res.sendFile(path.join(__dirname, 'storing','payroll.html'));
});
